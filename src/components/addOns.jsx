                ...
                <div className='Content'>
                    ...
                    <div className='Start' style={{display: "flex",flexDirection: "row", gap: "5%", justifyContent: "center"}}>
                        {items.slice(5, 10).map((item, index) => {
                            ...
                            return(
                                <div className='roomOptions' key={actualIndex}>
                                    <div style={{display: "flex",flexDirection: "column",width: "250px", backgroundColor: "grey", borderRadius: "10px", padding: "1rem", gap: "1rem", alignItems: "center"}} className='conferenceRoom'>
                                        ...
                                        <p style={{fontSize:"150%", textAlign: "center"}}>{item.name}<br/>${item.unitCost}</p>
                                        <p style={{display:"flex", flexDirection:"row", gap: "2rem", alignItems: "center", fontSize:"150%"}}>
                                            <span onClick={() => handleQuantityChange(actualIndex, "decrement")} style={{ backgroundColor: "green", padding: "0.25rem 0.5rem", marginRight: "0.5rem", borderRadius: "5px", cursor: "pointer" }}>-</span>
                                            <span>{item.quantity}</span>
                                            <span onClick={() => handleQuantityChange(actualIndex, "increment")} style={{ backgroundColor: "blue", padding: "0.25rem 0.5rem", borderRadius: "5px", cursor: "pointer" }}>+</span>
                                        </p>    
                                    </div>
                                </div>
                            )
